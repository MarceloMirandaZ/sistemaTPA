...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-09-2015 a las 00:12:11
...
INSERT INTO `cliente` (`idcliente`, `nom_cliente`, `cedula`, `email`, `telefono`, `direccion`) VALUES
(1, 'Marcelo', '1720259751', 'teshack@gmail.com', '0983732233', 'carapungo');
...
INSERT INTO `poliza` (`idpoliza`, `tipo_poliza`, `num_poliza`, `fecha_creacion`, `tipo_contrato`, `cliente`, `prima_poliza`, `fecha_vigencia`, `estado`) VALUES
(1, 1, '0001', '31-08-2015', 1, 1, '2000', '31-08-2016', 'vigente');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vista_cliente_poliza` AS select `c`.`idcliente` AS `idcliente`,`c`.`nom_cliente` AS `nom_cliente`,`c`.`cedula` AS `cedula`,`p`.`num_poliza` AS `num_poliza` from (`cliente` `c` join `poliza` `p`) where (`p`.`cliente` = `c`.`idcliente`);
